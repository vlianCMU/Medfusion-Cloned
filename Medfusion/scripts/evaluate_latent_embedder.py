...
# ----------------Settings --------------
batch_size = 100
max_samples = 2000 # set to None for all 
...
path_out = Path.cwd()/'results'/'Eye'/'metrics'
...
# ---------------- Dataset/Dataloader ----------------
ds_real = ImageFolder('/data1/shared/Changgeng_good_processed', transform=pil2torch)
...
# --------------- Load Model ------------------
model = VAE.load_from_checkpoint('/data1/lhy/medfusion-main/runs/2025_09_09_160606/epoch=5-step=257950.ckpt')
model.to(device)
