...
# ===================== User Config =====================
CKPT_PATH = "/data1/lhy/medfusion-main/finetune/2025_10_15_030800_finetune_unet/lightning_logs/version_0/checkpoints/last.ckpt"
...
MODE = "singleclass"  # "multilabel" or "singleclass"
...
SINGLECLASS_LIST = [0, 1, 2, 3, 4, 5, None]
...
def main():
    ...
    path_out = Path.cwd() / "generation_finetune_singleclass" / current_time
    ...
    if MODE == "multilabel":
        ...
        for cls in SINGLECLASS_LIST:
            label = "unconditional" if cls is None else DISEASES[cls]
