...
from medical_diffusion.data.datasets import FundusEyeDiseaseDataset, SynFundusDataset
...
from medical_diffusion.models.embedders import LabelEmbedder, TimeEmbbeding, FundusDiseaseEmbedder, FundusConditionEmbedder, SynFundusConditionEmbedder
...
if __name__ == "__main__":
    ...
    #     csv_path='/data1/lhy/medfusion-main/merged_shuffled.csv',
    #     crawler_ext='jpg',
    #     image_resize=256,
    ...
    # ds = FundusEyeDiseaseDataset(
    #     csv_path='/data1/lhy/medfusion-main/pub_qualitygood_eyeside.csv',
    #     crawler_ext='jpg',
    #     image_resize=256,
    #     augment_horizontal_flip=False,
    #     augment_vertical_flip=False,
    ...
    ds = SynFundusDataset(
        csv_path='/data1/lhy/SynFundus-1M_gen_cond_v3.csv',
        image_dir='/data3/SynFundus',
        crawler_ext='png',
        image_resize=256,
        augment_horizontal_flip=False,
        augment_vertical_flip=False,
    ...
    # ds = SynFundusDataset( ## lhy
    #     csv_path='/data1/lhy/medfusion-main/pub_qualitygood_eyeside.csv',
    #     crawler_ext='jpg',
    #     image_resize=256,  # 使用512x512尺寸
    #     augment_horizontal_flip=False,
    #     augment_vertical_flip=False,
    # )
    ...
    # path_run_dir = Path.cwd() / 'SynFundus-Model' / str(current_time)
    path_run_dir = Path.cwd() / 'new_pub' / str(current_time)
    ...
    # cond_embedder = LabelEmbedder ###lhy
    # cond_embedder_kwargs = {
    #     'emb_dim': 1024,
    #     # 'num_diseases': 6  # 6种疾病
    #     'num_classes': 6
    # }
    # cond_embedder = FundusConditionEmbedder
    # cond_embedder_kwargs = {
    #     'emb_dim': 1024,
    #     'num_diseases': 5  # 新的疾病数量
    # }
    cond_embedder = SynFundusConditionEmbedder
    cond_embedder_kwargs = {
        'emb_dim': 1024,
        'num_labels': 15  # 对应CSV中的15个标签
        # 'num_labels': 6  # 对应CSV中的6个标签
    }
    ...
    latent_embedder = VAE
    # latent_embedder_checkpoint = '/data1/lhy/medfusion-main/VAE/runs/2025_11_03_131056/epoch=11-step=35000.ckpt'
    # latent_embedder_checkpoint = '/data1/lhy/medfusion-main/VAE/runs/2025_09_10_193617/epoch=8-step=82950.ckpt'
    ...
    pipeline = DiffusionPipeline(
        ...
        use_ema=False,
        classifier_free_guidance_dropout=0.2, # Disable during training by setting to 0
        do_input_centering=False,
        clip_x0=False,
        sample_every_n_steps=2000 ###lhy
    )
