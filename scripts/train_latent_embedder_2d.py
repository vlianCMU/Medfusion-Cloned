...
from medical_diffusion.data.datasets import AIROGSDataset, MSIvsMSS_2_Dataset, CheXpert_2_Dataset, FundusEyeDiseaseDataset
...
if __name__ == "__main__":
    ...
    ds_4 = FundusEyeDiseaseDataset(
        csv_path='/data1/lhy/medfusion-main/merged.csv',  # 处理后的CSV文件
        crawler_ext='jpg',
