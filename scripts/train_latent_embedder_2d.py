...
from medical_diffusion.data.datasets import AIROGSDataset, MSIvsMSS_2_Dataset, CheXpert_2_Dataset, FundusEyeDiseaseDataset, SynFundusDataset
...
if __name__ == "__main__":
    ...
    path_run_dir = Path.cwd() / 'VAE' / 'runs' / str(current_time)
    ...
    print(f"最佳模型已保存至: {checkpointing.best_model_path}")
